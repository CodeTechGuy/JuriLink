          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <p className="text-muted-foreground text-lg md:text-xl max-w-md">
                Book appointments, consult via video, and manage your leagal issues 
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                >
                  <Link href="/doctors">Find Lawyers</Link>
                </Button>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Our platform makes legal services accessible with just a few clicks
            </p>
          </div>
      ...
      <section id="pricing" className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Choose the perfect consultation package that fits your legal service
              needs
            </p>
          </div>
            ...
            <CardContent className="p-8 md:p-12 lg:p-16 relative overflow-hidden">
              <div className="max-w-2xl relative z-10">
                <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                  Ready to take control of your legal issues?
                </h2>
                <p className="text-lg text-muted-foreground mb-8">
                  Join thousands of clients who have streamlined their legal journey with our platform. 
                  Get started today and experience legal services the way they should be.
                </p>
                <div className="flex flex-col sm:flex-row gap-4">
                  <Button
                    asChild
